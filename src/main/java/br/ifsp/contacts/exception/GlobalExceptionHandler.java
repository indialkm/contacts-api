...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<Map<String, String>> handlerResourceNotFoundException(ResourceNotFoundException exception)
	{
		...
		errorResponse.put("error", "Parceiro, vou te dá o papo. Esse trem que você está procurando não existe não.");
    ...
    public ResponseEntity<Map<String, String>> handleGenericException(Exception exception) {
        ...
        errorResponse.put("error", "Tururu, erro no servidor sabe o que quer dizer? Abre chamado.");
